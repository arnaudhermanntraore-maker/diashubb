  ...
  fr: {
    translation: {
      ...
      hero: {
        ...
        subtitle: "Achetez, vendez et investissez entre les États-Unis et l'Afrique avec confiance — titres vérifiés, paiements sécurisés, agents certifiés Diashubb.",
      ...
      property: { verified: "Vérifié Diashubb", aiScore: "Score IA", contact: "Contacter l'agent", tour: "Visite 360°", noResults: "Aucun bien trouvé" },
      banner: "Diashubb protège chaque transaction. Ne communiquez jamais en dehors de cette plateforme. Ne partagez aucune information bancaire par message.",
      ...
      dashboard: { title: "Mon portefeuille", us: "États-Unis", africa: "Afrique", listings: "Mes annonces", saved: "Favoris", txCount: "Transactions", diascoins: "DiasCoins" },
      agency: {
        title: "Espace Agence",
  ...
  en: {
    translation: {
      ...
      hero: {
        ...
        subtitle: "Buy, sell and invest across the US and Africa with confidence — verified titles, secure payments, Diashubb-certified agents.",
      ...
      property: { verified: "Diashubb Verified", aiScore: "AI Score", contact: "Contact agent", tour: "360° tour", noResults: "No properties found" },
      banner: "Diashubb protects every transaction. Never communicate outside this platform. Never share banking information in messages.",
      ...
      dashboard: { title: "My portfolio", us: "United States", africa: "Africa", listings: "My listings", saved: "Saved", txCount: "Transactions", diascoins: "DiasCoins" },
      agency: {
